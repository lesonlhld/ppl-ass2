...
Function: d**Here some too**Parameter: d Body: EndBody.""" 
    ...
    def test_test_408(self):
        ...
        Body: 
            ...
            i = i + 1;
        EndBody.""" 
        expect = Program([FuncDecl(Id("array"),[VarDecl(Id("i"),[],None),VarDecl(Id("j"),[],None),VarDecl(Id("arr"),[1001],None)],([],[Assign(ArrayCell(Id("a"),[Id("i")]),BinaryOp("+",ArrayCell(Id("arr"),[ArrayCell(ArrayCell(Id("c"),[BinaryOp("+",IntLiteral(2),Id("j"))]),[BinaryOp("*",ArrayCell(Id("b"),[Id("i")]),IntLiteral(4))])]),IntLiteral(4))),Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1)))]))])
        self.assertTrue(TestAST.checkASTGen(input,expect,408))
    def test_test_409(self):
        """Created automatically"""
    ...
    def test_test_401243(self):
        ...
        Body: 
            arr[1][2][3] = 4;
        EndBody.""" 
        expect = str(Program([FuncDecl(Id("arr"),[],([],[Assign(ArrayCell(Id("arr"),[IntLiteral(1),IntLiteral(2),IntLiteral(3)]),IntLiteral(4))]))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,324253))
    ...
    def test_test_407(self):
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,23432))
    ...
    def test_test_411(self):
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,32452323))

        
    
    def test_tes4324540(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,132421))

    def test_test4215327(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,326512))

    def test_tes4353654(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,783387))
    def test_test_4e2e356(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,84324))

    
    def test_323trjrcs01(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,37874301))
    def test_302thvd(self):
        """Created automatically"""
        input = r"""Function: callmore
        Body: 
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,3024122))
    def test_3321d33(self):
        """Created automatically"""
        ...
        self.assertTrue(TestAST.checkASTGen(input,expect,13234))