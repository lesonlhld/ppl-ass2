...
Var: m, n[10];
    ...
    def test_309(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("funcinfunc"),[],([],[Assign(Id("x"),IntLiteral(20)),Assign(Id("x"),FloatLiteral(100.0))]))])
    ...
    def test_310(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("nobody"),[],([],[If([(BinaryOp("==",Id("x"),Id("i")),[],[Break()])],())]))])
...
EndBody.""" 
    ...
    def test_313(self):
        ...
        Body: 
            ...
            EndIf.
        EndBody.""" 
        expect = Program([FuncDecl(Id("testn"),[VarDecl(Id("themdauchamphay"),[],None)],([],[If([(BinaryOp("==",Id("n"),IntLiteral(0)),[],[Return(IntLiteral(1))]),(BinaryOp(">",Id("n"),IntLiteral(0)),[],[Return(BinaryOp("*",Id("n"),CallExpr(Id("fact"),[BinaryOp("-",Id("n"),IntLiteral(1))])))])],([],[Return(Id("n"))]))]))])
...
**""" 
    ...
    def test_324(self):
        ...
        EndBody.
        """ 
        expect = Program([FuncDecl(Id("hellomoinguoi"),[VarDecl(Id("n"),[],None)],([],[If([(BinaryOp("<=.",Id("n"),FloatLiteral(0.00012)),[],[Assign(Id("n"),BinaryOp("*.",Id("n"),FloatLiteral(3.3)))]),(BinaryOp(">.",Id("n"),FloatLiteral(100.2)),[],[Assign(Id("n"),BinaryOp("\.",Id("n"),IntLiteral(5)))])],())]))])
    ...
    def test_335(self):
        ...
        Body: 
            x=arr[a+6];
        EndBody.""" 
        expect = Program([FuncDecl(Id("indexerror"),[],([],[Assign(Id("x"),ArrayCell(Id("arr"),[BinaryOp("+",Id("a"),IntLiteral(6))]))]))])
    ...
    def test_336(self):
        ...
        Body: 
             x = (a >=. 2.3e-13 || (x =/= 2e-35));
        EndBody.""" 
        expect = Program([FuncDecl(Id("misspareninop"),[],([],[Assign(Id("x"),BinaryOp(">=.",Id("a"),BinaryOp("||",FloatLiteral(2.3e-13),BinaryOp("=/=",Id("x"),FloatLiteral(2e-35)))))]))])
...
EndBody.""" 
    ...
    def test_341(self):
        ...
        Body: 
            ...
            EndIf.
        EndBody.""" 
        expect = Program([FuncDecl(Id("if__more_Else"),[VarDecl(Id("khaibaobien"),[],None)],([],[If([(BinaryOp("==",Id("n"),IntLiteral(0)),[],[Return(IntLiteral(1))])],([],[Return(BinaryOp("*",Id("n"),CallExpr(Id("fact"),[BinaryOp("-",Id("n"),IntLiteral(1))])))]))]))])
    ...
    def test_342(self):
        ...
        Body: 
            ...
            EndIf.
        EndBody.""" 
        expect = Program([FuncDecl(Id("iFElseIFNotElse"),[VarDecl(Id("n"),[],None)],([],[If([(CallExpr(Id("bool_of_string"),[StringLiteral("True")]),[],[Assign(Id("a"),CallExpr(Id("int_of_string"),[CallExpr(Id("read"),[])]))]),(BinaryOp("=/=",Id("n"),FloatLiteral(1.08)),[],[Assign(Id("b"),BinaryOp("+.",CallExpr(Id("float_of_int"),[Id("a")]),FloatLiteral(2.0)))]),(BooleanLiteral(False),[],[Return(Id("n"))])],())]))])
    ...
    def test_346(self):
        ...
        Body:
            ...
            EndIf.
        EndBody.""" 
        expect = Program([FuncDecl(Id("nothen"),[],([],[If([(BinaryOp("==",Id("e"),BooleanLiteral(True)),[],[CallStmt(Id("print"),[StringLiteral("Hello cac cau\\n")])])],())]))])
    ...
    def test_359(self):
        ...
        Body:
            ...
            EndWhile.
        EndBody.""" 
        expect = Program([FuncDecl(Id("miss_one_do"),[],([],[While(BinaryOp("<",Id("a"),IntLiteral(100)),([],[Dowhile(([],[Assign(Id("a"),BinaryOp("-",Id("a"),IntLiteral(30)))]),BinaryOp(">",Id("a"),IntLiteral(1)))]))]))])
    ...
    def test_363(self):
        ...
        Body: 
            ...
            EndFor.
        EndBody.""" 
        expect = Program([FuncDecl(Id("breakwithoutsemi"),[],([],[For(Id("i"),IntLiteral(0),BinaryOp("!=",Id("i"),IntLiteral(9)),BinaryOp("*.",Id("i"),FloatLiteral(2.0)),([],[If([(BinaryOp(">=",Id("i"),IntLiteral(10)),[],[Break()])],())]))]))])
...
Function: d**Here some too**Parameter: d Body: EndBody.""" 
    ...
    def test_394(self):
        ...
        Body: 
            ...
            EndIf.
        EndBody.""" 
        expect = Program([FuncDecl(Id("ifOKE"),[],([],[If([(BinaryOp("==",Id("n"),IntLiteral(0)),[],[Assign(Id("x"),IntLiteral(3))]),ElseIf(BinaryOp("!=",Id("x"),IntLiteral(2)),[],[Assign(Id("check"),BooleanLiteral(False))])],())]))])
    ...
    def test_400(self):
        """Created automatically"""
        input = r"""Var: x =5.2e-4 ;""" 
        expect = Program([VarDecl(Id("x"),[],FloatLiteral(0.00052))])
